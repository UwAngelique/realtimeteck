...
<?php if(!$adminConfig['hide_twitter_feed']){ ?>
		...
		<div class="col-md-4" id="twitter-feed">
			<h3>
				<?php echo $Translation["Realtimeteck tweets"]; ?>
				<span class="pull-right">
					<a class="twitter-follow-button" href="https://twitter.com/Uw_Angelique" data-show-count="false" data-lang="en"><?php echo $Translation["follow BigProf"]; ?></a>
					<script type="text/javascript">
						window.twttr = (function (d, s, id) {
							var t, js, fjs = d.getElementsByTagName(s)[0];
							if (d.getElementById(id)) return;
							js = d.createElement(s); js.id = id;
							js.src= "https://twitter.com/Uw_Angelique";
			...
			<div class="text-center">
				<a class="twitter-timeline" height="400" href="https://twitter.com/Uw_Angelique" data-widget-id="552758720300843008" data-chrome="nofooter noheader"><?php echo $Translation["loading bigprof feed"]; ?></a>
				<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://twitter.com/Uw_Angelique";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
			</div>
