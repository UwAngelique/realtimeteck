<?php
	...
	$Translation["Realtimeteck tweets"]  = "Tweets By Realtimeteck";
	$Translation["follow Realtimeteck"] = "Follow @Uw_Angelique";
	$Translation["loading Realtimeteck feed"] = "Loading @Realtimeteck feed ...";
